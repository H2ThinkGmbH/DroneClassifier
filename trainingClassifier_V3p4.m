...
numClasses = 4;  (for the four drone classes)
if exist(sfn_classifier) == 0
    % Adapting the vggish network; the orignal vggish network can be found here:
    % https://github.com/tensorflow/models/tree/master/research/audioset/vggish
    net = vggish;
    lgraph = layerGraph(net.Layers);

    % Change the outputlayer to numClasses
    lgraph = removeLayers(lgraph,"regressionoutput");
    lgraph = addLayers(lgraph,[ ...
        fullyConnectedLayer(numClasses,Name="FCFinal",WeightLearnRateFactor=numClasses,BiasLearnRateFactor=numClasses) ...
